...
(function ($) {
    ...
    var isOverElement = function (elm, mouseX, mouseY) {
        ...
        var range = {
            x: [offset.left, offset.left + elm.width()],
            ...
            selection.insertAfter(
                ...
                .each(function () {
                    ...
                    var preview =
                        ...
                        .appendTo('#backpages')
                        .css({
                            top: settings.wrapperOffset * 2 + 'px'
                        });
            ...
            selection.bind({
                peek: function (e, data) {
                    ...
                    if (typeof currentPeek !== 'undefined') {
                        currentPeek.stop().css({
                            top: settings.hiddenOffset + 'px'
                        });
                    }
                ...
                peekchange: function (e, data) {
                    slide(currentPeek, settings.hiddenOffset, {
                        duration: settings.speed * 1.3,
                        easing: 'swing'
                    });
                ...
                unpeek: function (e, data) {
                    slide(wrapper, settings.unpeekedWrapperOffset, {
                        immediate: data.navigated
                    });
                    slide(currentPeek, settings.unpeekedOffset, {
                        immediate: data.navigated
                    });
    ...
    $.fn.rainbow = function (options) {
        ...
        $(this.selector + ' span')
            .bind('mouseover', function (e) {
                var span = $(e.target);
                span.animate({
                    color: span.data('to-color')
                }, {
                    duration: settings.colorDuration,
                    queue: false
                });
            })
            .bind('mouseout', function (e) {
                $(e.target).animate({
                    ...
                    duration: settings.unColorDuration,
                    queue: false
                });
            });
        return this;
